...
namespace GoodeBooks.Database.Migrations
{
    ...
    [Migration("20230527200348_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodeBooks.Models.Entities.SaleInfo", b =>
                {
                    b.HasOne("GoodeBooks.Models.Entities.Volume", "Volume")
                        .WithOne("SaleInfo")
                        .HasForeignKey("GoodeBooks.Models.Entities.SaleInfo", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GoodeBooks.Models.Entities.SearchInfo", b =>
                {
                    b.HasOne("GoodeBooks.Models.Entities.Volume", "Volume")
                        .WithOne("SearchInfo")
                        .HasForeignKey("GoodeBooks.Models.Entities.SearchInfo", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GoodeBooks.Models.Entities.VolumeInfo", b =>
                {
                    b.HasOne("GoodeBooks.Models.Entities.Volume", "Volume")
                        .WithOne("VolumeInfo")
                        .HasForeignKey("GoodeBooks.Models.Entities.VolumeInfo", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
